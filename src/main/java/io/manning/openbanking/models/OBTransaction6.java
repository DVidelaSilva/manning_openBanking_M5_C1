...
public class OBTransaction6 {
   ...
   */
  public OBTransaction6(String accountId, OBCreditDebitCode1 creditDebitIndicator, ExternalEntryStatus1Code status, OffsetDateTime bookingDateTime, OBActiveOrHistoricCurrencyAndAmount9 amount) {
