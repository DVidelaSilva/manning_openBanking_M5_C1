...
public class OBStatement2Basic {
   ...
   */
  public OBStatement2Basic(String accountId, OBInternalStatementType1Code type, OffsetDateTime startDateTime, OffsetDateTime endDateTime, OffsetDateTime creationDateTime) {
