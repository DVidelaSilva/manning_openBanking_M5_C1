...
import io.manning.openbanking.models.OBStatement2DetailStatementAmountInner;
...
public class OBStatement2Detail {
   ...
   */
  public OBStatement2Detail(String accountId, OBInternalStatementType1Code type, OffsetDateTime startDateTime, OffsetDateTime endDateTime, OffsetDateTime creationDateTime) {
